...
<template>
  <div>
    ...
    <div class="grid grid-cols-7 gap-4">
      <BaseInputGroup label="起始薪資" type="integer" icon="" name="salary_amount" :min="0" :max="10e8"
      ...
      <BaseInputGroup label="餘額轉投資比率" type="float" icon="" name="investment_ratio" :min="0" :max="100"
  ...
  <div>
    ...
    <div class="grid grid-cols-7 gap-4">
      <BaseInputGroup label="起始年齡" type="integer" icon="" name="start_year" :min="0" :max="150"
        v-model:value="formInput.start_year" suffix=" 歲" class="col-span-1" />
      <BaseInputGroup label="購屋時年齡" type="integer" icon="" name="house_start_year" :min="0" :max="150"
      ...
      <BaseInputGroup label="退休年齡" type="integer" icon="" name="retire_age" :min="0" :max="150"
  ...
  <div>
    ...
    <div class="grid grid-cols-7 gap-4">
      ...
      <BaseInputGroup label="年利率" type="float" icon="" name="interest" :min="0" :max="100"
        v-model:value="formInput.interest" prefix="%" class=col-span-1 />
      <BaseInputGroup label="貸款年限" type="integer" icon="" name="loan_term" :min="0" :max="50"
